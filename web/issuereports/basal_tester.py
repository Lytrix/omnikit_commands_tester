...
def get_times_units(rawgit_page_pdm_values):
    ...
    with open("/Users/eelkejager/Documents/omnipod/faultevents/omnipod_commands/omnikit_commands_tester/testers/2notok.md", 'r') as input_data_text:
        input_data_text = input_data_text.read()
...
def main():
    ...
    # basal_captures_wikipage = "/Users/eelkejager/Documents/omnipod/faultevents/omnipod_commands/omnikit_commands_tester/testers/2notok.md"
